...
def graphic_loss_creation(form_data, name, dataset):
    fig = Figure()
    axis = fig.add_subplot(1, 1, 1)
    if(form_data['graphicLoss'] == 'graphicLossIntent'):
        df_intent = pd.read_csv('results_intent_' + name + '_' + dataset + '.csv')
        ...
        df_sentiment = pd.read_csv('results_sentiment_' + name + '_' + dataset + '.csv')
        axis.plot(df_sentiment[['Loss Training', 'Loss Validation']])
        axis.legend(['Loss Training', 'Loss Validation'])
    elif(form_data['graphicLoss'] == 'graphicLossEntities'):
        df_entities = pd.read_csv('results_entities_' + name + '_' + dataset + '.csv')
    ...
    if(form_data['graphicLoss'] == 'graphicLossIntent'):
        fig.savefig(os.path.join('static', 'images','loss_intent_' + name + '_' + dataset + '.png'))
    elif(form_data['graphicLoss'] == 'graphicLossSentiment'):
        fig.savefig(os.path.join('static', 'images','loss_sentiment_' + name + '_' + dataset + '.png'))
    elif(form_data['graphicLoss'] == 'graphicLossEntities'):
        fig.savefig(os.path.join('static', 'images','loss_entities_' + name + '_' + dataset + '.png'))

def graphic_score_creation(form_data, name, dataset):
    fig = Figure()
    axis = fig.add_subplot(1, 1, 1)
    ...
    if not os.path.isdir(os.path.join('static', 'images')):
        os.mkdir(os.path.join('static', 'images'))
    if(form_data['graphicScore'] == 'graphicScoreIntent'):
        fig.savefig(os.path.join('static', 'images','score_intent_' + name + '_' + dataset + '.png'))
    elif(form_data['graphicScore'] == 'graphicScoreSentiment'):
        fig.savefig(os.path.join('static', 'images','score_sentiment_' + name + '_' + dataset + '.png'))
    elif(form_data['graphicScore'] == 'graphicScoreEntities'):
        fig.savefig(os.path.join('static', 'images','score_entities_' + name + '_' + dataset + '.png'))